    ...
    function addToCart() {
      ...
      if(!itemExist) {
        const newItem = {product, qty};
         ...
         toast.success("Cart Ttem added successfully");
      } 
    }
      ...
      <div className="row f-flex justify-content-around">
        ...
        <div className="col-12 col-lg-5 mt-5">
          ...
          <div className="stockCounter d-inline">
            ...
            <input type="number" className="form-control count d-inline" value={qty}
              readOnly
            />
            <span className="btn btn-primary plus" onClick={increaseQty}>+</span>
          </div>
          <button
            type="button" id="cart_btn" onClick = {addToCart} disabled={product.stock==0} className="btn btn-primary d-inline ml-4"
           >
            Add to Cart
          </button>
          <hr />
